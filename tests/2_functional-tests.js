...
suite("Functional Tests", function () {
  ...
  suite("Test with GET", function () {
    function got(done, title, text, creator) {
      chai
        .request(server)
        .post("/api/issues/got")
        .send({
    ...
    this.beforeAll(function (done) {
      got(done, "get title", "get text", "me");
      got(done, "get title", "get text", "you");
      got(done, "get title", "get text", "us");
      got(done, "get title", "get text", "them");
    });

    test("#1 - View issues on a project : GET", function (done) {
      browser.visit("/api/issues/got", function () {
